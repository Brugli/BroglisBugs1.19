...
public record BroglisBugsEntityBiomeModifier(HolderSet<Biome> biomes, MobSpawnSettings.SpawnerData spawnerData) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return BroglisBugsBiomeModifiers.ENTITY_MODIFIER.get();
    }
}
